  ...
  const timeline: TimelineItem[] = [
    {
      ...
      description: "Focusing on fullstack web development, multi-modal AI voice agents, and real-time interactive web applications.",
      highlights: ["Task Caretaker Productivity System", "JARVIS Voice Automation Agent", "Delhi Visit Interactive Explorer"],
      icon: <Award className="w-5 h-5 text-[#7C5CFC]" />,
    },
    {
      year: "2025",
      title: "FULLSTACK & REAL-TIME APPS",
      role: "Project Developer",
      description: "Designed responsive real-time web applications, interactive interfaces, and intelligent automation tools.",
      highlights: ["ChitChat Web Real-Time Messaging", "Fullstack Portfolio OS Blueprint", "Data Structures & Algorithm Problem Solving"],
